local function theme_setup()
    ...
    local highlights = {
        ...
        -- Diagnostic
        DiagnosticError = { fg = p.brightred, bg = p.bg6},
        DiagnosticHint = { fg = p.dullgreen, bg = p.bg7 },
        DiagnosticInfo = { fg = p.lightblue, bg = p.bg9 },
        DiagnosticWarn = { fg = p.lightyellow, bg = p.bg8 },
        ...
        ["@field"] = { fg = p.lightred },
        ["@float"] = { link = "@number" },
        ["@function"] = { fg = p.lightred },
        ["@function.builtin"] = { fg = p.lightgreen },
        ["@function.macro"] = { fg = p.lightgreen },
        ["@include"] = { fg = p.darkblue },
        ["@keyword"] = { fg = p.darkblue, italic = true },
        ["@keyword.function"] = { fg = p.brightgreen, italic = true },
        ["@keyword.operator"] = { fg = p.darkblue, italic = true },
        ["@keyword.return"] = { fg = p.brightgreen, italic = true },
        ["@keyword.conditional"] = { fg = p.purple, italic = true },
