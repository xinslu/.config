...
export PATH="/home/kinshukphalke/.config/networkmanager-dmenu-2.1.0/networkmanager_dmenu:/home/kinshukphalke/greenclip:$PATH"
...
alias circuitsim='java --module-path ~/Downloads/javafx-sdk-18.0.2/lib/ --add-modules=javafx.controls -jar ~/Downloads/CircuitSim1.8.3.jar'
...
# plugins=(git zsh-syntax-highlighting dnf zsh-interactive-cd)
